package presentation.scenes.meditationPath.meditationEndView;
...
public class MeditationEndController implements AnimatedViews {
    ...
    public MeditationEndController(App app) {

        this.app = app;

        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("MeditationEndView.fxml"));
