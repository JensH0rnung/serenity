package presentation.scenes.motivationPath.motivationEndView;
...
public class MotivationEndController implements AnimatedViews {
    ...
    public MotivationEndController(App app) {

        this.app = app;

        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("MotivationEndView.fxml"));
